...
import { sampleFundData } from '../data/sampleFundData';
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-6xl mx-auto pt-72 pb-2 px-4">
        <h1 className="text-5xl md:text-6xl font-serif font-normal text-green-900 mb-6">GreenHarbor US Value Fund</h1>
      </div>
          ...
          {subNav.map((item, idx) => (
            <a
              ...
              className={
                ...
                (idx === 2 ? ' underline bg-green-50 px-2 py-1 rounded' : '')
              }
            >
              {item.label}
            </a>
      ...
      <div className="max-w-4xl mx-auto px-4 mt-12">
        ...
        <ul className="list-disc pl-8 text-lg text-gray-800 space-y-2">
          <li>Seek return potential from high-quality undervalued US companies with strong financials and cash flows.</li>
          <li>Employ risk management that prioritizes stability and downside risk mitigation.</li>
          <li>Leverage a seasoned management team with decades of value investing experience.</li>
        </ul>
      </div>

      {/* Fund Data Grid */}
      <div className="mt-16">
        <FundDataGrid fundData={sampleFundData} />
      </div>
    </div>
  );
} 