    ...
    <div className="min-h-screen bg-white flex flex-col">
      <div className="w-full max-w-4xl mx-auto py-2 flex-1 pt-40">
        ...
        <ul className="list-disc list-inside text-gray-700 mb-10 space-y-2">
          <li>
            <span className="font-semibold">Submit a Job Opening:</span> Fill out our easy-to-use form to post your job vacancies directly on our platform. <a href="#job-form" className="text-blue-600 underline hover:text-blue-800">Job Submission Form</a>
          </li>
          <li>
