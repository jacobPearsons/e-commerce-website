            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${formData.notifications.email ? 'bg-primary-500' : 'bg-gray-200 dark:bg-gray-700'
                    }`}
                >
                  <span
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${formData.notifications.push ? 'bg-primary-500' : 'bg-gray-200 dark:bg-gray-700'
                    }`}
                >
                  <span
                  ...
                  <label key={theme.id} className="flex items-center space-x-3 cursor-pointer">
                    <input
                      ...
                      checked={
                        ...
                        (theme.id === 'light' && !isDark && localStorage.getItem('theme') === 'light') ||
                        (theme.id === 'system' && localStorage.getItem('theme') === 'system')
                      }
